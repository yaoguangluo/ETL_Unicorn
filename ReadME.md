# 🔥 <<97%属于(首创)个人著作权开源项目 (3%借鉴sum tech的开源组件实例(拖标样式，Jtree样式和分割板样式) 和 Knime的节点包命名规则(configure, exec, view)), 神经元皮肤灵感思想来自牛顿教授的各种脑科图片>>Deta ETL AI workflow tool software for data mining piple line operations include theme system.  /德塔人工智能数据分析ETL 可重用节点工作流处理软件带皮肤系统。 
...
![实例](https://images.gitee.com/uploads/images/2019/0604/025703_3a9449d3_5008798.png)
...
##### ![实例](http://progressed.io/bar/51?title=completed)正完善功能 带单例运行记录，保存，载入，刷新。删除 20190605
